...
public class BasicCompTest {
	...
	private static final String[] TESTS = {
		...
		"2C00; AC=AAAA,101=0400,400=5555; DR=5555,AC=0000,BR=0000,AR=400,N=0,Z=1,V=0", // AND
		"2DFE; AC=0000,0FF=0600,600=FFFF; DR=FFFF,AC=0000,BR=FFFE,AR=600,N=0,Z=1,V=0,0FF=0601", // AND
//		"2B80; AC=FFFF,081=0011,010=0000; DR=0000,AC=0000,BR=FF80,AR=010,N=0,Z=1,V=0,081=0010", // AND
		"2801; SP=700,AC=5555,701=6666; DR=6666,AC=4444,BR=0001,AR=701,N=0,Z=0,V=0", // AND
		...
		"8808; SP=400,408=0BEC; AR=408,DR=0BEB,BR=0BEA,IP=101,408=0BEB", // LOOP
...
//		"B800; AC=6666,SP=600,600=0000; DR=6666,AC=0000,BR=0000,AR=600,N=0,Z=1,V=0,600=6666", // SWAM

		"C200; ; IP=200", // JUMP
		"CE80; ; DR=0081,IP=081,BR=FF80", // JUMP
		"CC00; 101=F00F; DR=F00F,IP=00F,BR=0000,AR=101", // JUMP
		...
		"DC00; SP=401,101=F00F; DR=0101,IP=00F,SP=400,BR=F00F,AR=400,400=0101", // CALL

		"E200; AC=BEEF; DR=BEEF,AR=200,200=BEEF", // ST
		"EE80; AC=1313; DR=1313,AR=081,BR=FF80,081=1313", // ST
		"EC00; AC=0000,101=F00F; DR=0000,BR=0000,AR=00F,00F=0000", // ST
		"E808; AC=0BEC,SP=400; DR=0BEC,BR=0008,AR=408,408=0BEC", // ST
