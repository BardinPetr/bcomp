...
public class InstructionWord extends MemoryWord {
    ...
    public void setValueByOpcode(int typeMask, int argument) {
        value = 0xFFFF & (instruction.opcode | typeMask | argument);
    }

    public void setValueByOpcode(int argument) {
        setValueByOpcode(0, argument);
    }
}
